            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form action="{{ url('/register') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text"
                                class="form-control @error('telephone') is-invalid @enderror form-control-xl"
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text"
                                class="form-control @error('address') is-invalid @enderror form-control-xl"
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <select class="form-control @error('role') is-invalid @enderror form-control-xl"
